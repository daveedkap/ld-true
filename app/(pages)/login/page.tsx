...
export default function LoginPage() {
  ...
  return (
    <main className="h-screen w-screen bg-white flex flex-col sm:flex-row items-center justify-center font-sans px-4 gap-y-6 sm:gap-x-10">
      {/* 🐰 Bunny Animation */}
      <div className="w-full sm:w-[300px] max-w-xs sm:max-w-md">
